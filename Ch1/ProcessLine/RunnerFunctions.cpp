...
{
    printf("Valid arguments are:\n\n    -m (run mode - must be supplied)\n    -n (optional numeric argument where appropriate based on mode)\n\nModes are as follows:\n\n");
    ...
    // Iterate until we find a match or hit the "Bad Args" / default case at the end of the array
    while( (currentMode = ModeArray[currentPosition++])->TriggerCharacter != BADARGS_TRIGGER)
    {
